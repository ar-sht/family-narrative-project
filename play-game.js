...
const nataStories = [[[[[[], [], `<span class="story">&emsp;&emsp;After 20 days, the organization that housed you tells you that you've been approved to take the next train to Italy. You gather your things and walk to the station. The trains are guarded by troops, and you look at them nervously. You're told they're only here because you're a refugee and a possible threat, but you still feel uneasy about it.</span><br><span class="introduce-decision">You can follow your instincts and</span><br><div class="choice"><button class="decision" id="instinct" value="0">Stay in Vienna</button>${htmlOr}<button class="decicion" id="board" value="1">Board the train</button></div>`], [], 
